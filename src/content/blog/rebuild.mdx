...
What really kicked of the new hype-train was my introduction to [Astro](https://astro.build) from [Theo](https://t3.gg). The concept of partial hydration instantly blew my away and its **blazingly fast** performance left me in awe. tl;dr on Astro: it's component syntax is super intuitive and its rich integration ecosystem makes it super easy to pick up. _A more in-depth article on Astro is in the works. There's just so much to unpack here 🤯!_
