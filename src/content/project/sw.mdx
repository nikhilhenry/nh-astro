...
Launched as part of the _mental awareness week_ campaign during my presidential term in my junior year of highschool.
...
![Daily Highlight](/assets/blog/sw-1.png)
![Daily Highlight 2](/assets/blog/sw-2.png)

### Unsplash API

Production ready and approved Unsplash API integration for cover images, powered by a text search.
![Unsplash API](/assets/blog/sw-3.png)
...
![Login Page](/assets/blog/sw-4.png)
...
![Mood Scape](/assets/blog/sw-5.png)
